...
if __name__ == "__main__":
    ...
    arguments = [
        "--test_path",
        "chemprop_patent+mcts_train_smiles.csv",
        "--preds_path",
        "chemprop_patent+mcts_train_smiles_preds.csv",
        "--uncertainty_method",
        "ensemble",
        "--checkpoint_dir",
        "models/patent_MCTS_checkpoints_ensemble",
    ]
    ...
    print(
        chemprop.train.make_predictions(
            args=args, model_objects=model_objects, return_uncertainty=True
        )
    )
