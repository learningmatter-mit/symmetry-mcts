...
if __name__ == '__main__':
    ...
    core = {'smiles': '[H]c1ccc(-c2sc3c(oc4c3sc3c5sc6c(oc7c(CC(CCCCCC)CCCCCCCC)c(-c8ccc([H])s8)sc76)c5c(F)c(F)c43)c2CC(CCCCCC)CCCCCCCC)s1', 'label': 'opd', 'group': 'zero', 'blocks': [{'smiles': '[He]c1ccc(-c2sc3c(oc4c3sc3c5sc6c(oc7c(CC(CCCCCC)CCCCCCCC)c(-c8ccc([He])s8)sc76)c5c(F)c(F)c43)c2CC(CCCCCC)CCCCCCCC)s1'}]}
